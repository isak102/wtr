...
impl Parameter {
    ...
    pub fn get_color(&self) -> Option<(Color, Color)> {
        ...
        let cutoffs = match self.name {
            ...
            ParameterName::tcc_mean => color_cutoffs!(2.0, 4.0, false),
            ParameterName::lcc_mean => color_cutoffs!(2.0, 4.0, false),
            ParameterName::mcc_mean => color_cutoffs!(2.0, 4.0, false),
            ParameterName::hcc_mean => color_cutoffs!(2.0, 4.0, false),
